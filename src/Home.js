  ...
  <div>
            <div>
                <Carousel autoPlay>
                    ...
                    <Carousel.Item>
                        <div className="img-gradient">
                            <img className="d-block w-100 carouselImage" alt="Second slide" width="100%" src="https://constructionblog.autodesk.com/wp-content/uploads/2020/03/Construction-industry-statistics.jpg"/>
                        </div>
                        <Carousel.Caption className = "transparentBg" >
